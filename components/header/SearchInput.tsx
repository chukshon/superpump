...
const SearchInput = () => {
  return (
    <div className="relative border-gradient py-[15px] px-[10px] w-[450px] flex items-center gap-[10px]">
      <input
      ...
      />
      <button className="text-neutral-0 z-30 rounded-[4px] w-[30%] bg-custom-radial py-[6px] px-[20px]">
        Search
      </button>
